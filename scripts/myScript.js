$(document).ready(function(){
    ...
    $('.toggle-ball, .mobile-toggle-ball').click(function(){
        ...
        $('body, #header, .nav-wide li a, .menu-div, .mobile-nav-a, .btn-line, img, .banner, .offers-wrapper > div, .educ-sec-2 ul li .content, .educ-sec-2 ul li .content p, .testimonies-content h4, .testimonies-content p:nth-child(3), .wrapper-body').toggleClass('dark');
